...
public class JsonldSignatureFacadeTest {
    @Test
    public void test_simple() throws IOException, ParseException, java.text.ParseException, JoseException, JsonLdError {
        ...
        JSONObject result = jsonldSignatureFacade.sign(jsonObject, "secret/private_pcks8");
        assertNotNull("result is null", result);
        assertNotNull("signature null", result.get("signatureValue"));
    }
}
